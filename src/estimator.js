const covid19ImpactEstimator = (data) => {
  ...
  const dollarsInFlight = Math.trunc((infectionsByRequestedTime * 0.65 * 1.5) / data.timeToElapse);
  ...
  const severeImpact = {
    ...
    dollarsinFight: Math.trunc((sevImpactinfecTime * 0.65 * 1.5) / data.timeToElapse)
  };
